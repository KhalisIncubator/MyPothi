...
const editApiFactory = ({ state, setState }) => {
    const { isEditMode, selectedLineID, selectedElement } = state;
...
export { gutkaAPIFactory, viewerApiFactory, editApiFactory, searchApiFactory };
